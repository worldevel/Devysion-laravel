...
<!-- <section id="banner">
  <div class="banner-container">
    ...
    <div class="banner-inner" role="listbox">
      ...
      <div class="banner-item active" style="background:linear-gradient(rgba(0, 0, 0, 0.65),rgba(0, 0, 0, 0.65)), url({{asset('assets/img/bg-image-1.jpeg')}})">
        <div class="banner-container">
          <div class="container">
...
<main id="main">
  <section class="detail-intro">
    <img src="{{asset('assets/img/projects/branding_1.jpg')}}" alt="projects" class="img-fluid" style="width: 100% ;" />
  </section>
